...
c10::Scalar torch_scalar(
    ...
    double doubleValue, float complex64RealValue, float complex64ImaginaryValue,
    float complex128RealValue, float complex128ImaginaryValue, bool boolValue) {
  switch (dtype) {
    case torch::kInt8:
    case torch::kInt16:
    case torch::kInt32:
...
std::vector<c10::DeviceType>& device_dict() {
  static std::vector<c10::DeviceType> device_dict_ = {
      ...
      c10::DeviceType::FPGA,   c10::DeviceType::ORT,   c10::DeviceType::XLA,
      c10::DeviceType::Vulkan, c10::DeviceType::Metal, c10::DeviceType::XPU,
      c10::DeviceType::Meta,   c10::DeviceType::HPU,   c10::DeviceType::VE,
      c10::DeviceType::Lazy,
...
c10::optional<long> safe_mult(long a, long b) {
  if (a == 0)
    return 0;
  else if (b == 0)
    return 0;
...
bool is_too_big(std::vector<long> shape) {
  ...
  for (size_t i = 1; i < shape.size(); i++) {
    c10::optional<long> res = safe_mult(acc, shape[i]);
